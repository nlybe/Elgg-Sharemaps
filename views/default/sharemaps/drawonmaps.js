...
///////////////////////////////////////////////////////////////////////////////////////		  
        ...
        $('#geocoding_btn').on("click", function (e) {
            e.preventDefault();
            ...
            if ($('input:radio[name=drawwhat]:checked').val() == 'line') {	// add a new line 
                ...
                if (path_line.length > 0) {
                    ...
                    if ($('#line_' + map_polylines.indexOf(map_line)).length) {
                        ...
                        // APPLY_TO_DRAWONMAPS
                        $('#allmarks').append('<div id="line_' + map_polylines.indexOf(map_line) + '_div"><input name="line_title[]" type="text" id="line_' + map_polylines.indexOf(map_line) + '" value="Line #' + map_polylines.indexOf(map_line) + '"><input name="line_coords[]" id="line_coords_' + map_polylines.indexOf(map_line) + '" type="text" value="' + path_line.getArray().toString() + '">&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-xs" id="line_' + map_polylines.indexOf(map_line) + '_edit" >Edit</button>&nbsp;&nbsp;<button type="button" class="btn btn-danger btn-xs" id="line_' + map_polylines.indexOf(map_line) + '_delete" >Remove</button></div>');
                    }
                    setPolylineEditable(map_polylines.indexOf(map_line), false);
                    
                    // delete polyline and its input boxes - APPLY_TO_DRAWONMAPS
                     $('#line_' + map_polylines.indexOf(map_line) + '_delete').on("click", function () {
                         deletePolyline(map_polylines.indexOf(map_line));
                     });

                     // edit polyline and its input boxes - APPLY_TO_DRAWONMAPS
                     $('#line_' + map_polylines.indexOf(map_line) + '_edit').on("click", function () {
                         editPolyline(map_polylines.indexOf(map_line));
                     });                     
                }
                ...
                if (path_poly.length > 0) {
                    ...
                    if ($('#poly_' + map_polygons.indexOf(map_polygon)).length) {
                        ...
                        // APPLY_TO_DRAWONMAPS
                        $('#allmarks').append('<div id="poly_' + map_polygons.indexOf(map_polygon) + '_div"><input name="poly_title[]" type="text" id="poly_' + map_polygons.indexOf(map_polygon) + '" value="Polygon #' + map_polygons.indexOf(map_polygon) + '"><input name="poly_coords[]" id="poly_coords_' + map_polygons.indexOf(map_polygon) + '" type="text" value="' + path_poly.getArray().toString() + '">&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-xs" id="poly_' + map_polygons.indexOf(map_polygon) + '_edit" >Edit</button>&nbsp;&nbsp;<button type="button" class="btn btn-danger btn-xs" id="poly_' + map_polygons.indexOf(map_polygon) + '_delete" >Remove</button></div>');
                    }
                    setPolygonEditable(map_polygons.indexOf(map_polygon), false);
                    
                    // delete polygon and its input boxes - APPLY_TO_DRAWONMAPS
                    $('#poly_' + map_polygons.indexOf(map_polygon) + '_delete').on("click", function () {
                        deletePolygon(map_polygons.indexOf(map_polygon));
                    });

                    // edit polygon and its input boxes - APPLY_TO_DRAWONMAPS
                    $('#poly_' + map_polygons.indexOf(map_polygon) + '_edit').on("click", function () {
                        editPolygon(map_polygons.indexOf(map_polygon));
                    });                     
               }
                ...
                if (path_rect.toString().length > 0) {
                    ...
                    if ($('#rect_' + map_rectangles.indexOf(map_rectangle)).length) {
                        ...
                        // APPLY_TO_DRAWONMAPS
                        $('#allmarks').append('<div id="rect_' + map_rectangles.indexOf(map_rectangle) + '_div"><input name="rect_title[]" type="text" id="rect_' + map_rectangles.indexOf(map_rectangle) + '" value="Rectangle #' + map_rectangles.indexOf(map_rectangle) + '"><input name="rect_coords[]" id="rect_coords_' + map_rectangles.indexOf(map_rectangle) + '" type="text" value="' + path_rect.toString() + '">&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-xs" id="rect_' + map_rectangles.indexOf(map_rectangle) + '_edit" >Edit</button>&nbsp;&nbsp;<button type="button" class="btn btn-danger btn-xs" id="rect_' + map_rectangles.indexOf(map_rectangle) + '_delete" >Remove</button></div>');
                    }
                    setRectangleEditable(map_rectangles.indexOf(map_rectangle), false);
                    
                    // delete rectangle and its input boxes - APPLY_TO_DRAWONMAPS
                    $('#rect_' + map_rectangles.indexOf(map_rectangle) + '_delete').on("click", function () {
                        deleteRectangle(map_rectangles.indexOf(map_rectangle));
                    });

                    // edit rectangle and its input boxes - APPLY_TO_DRAWONMAPS
                    $('#rect_' + map_rectangles.indexOf(map_rectangle) + '_edit').on("click", function () {
                        editRectangle(map_rectangles.indexOf(map_rectangle));
                    });                     
                }
                ...
                if (path_circle.length > 0) {
                    if ($('#circle_' + map_circles.indexOf(map_circle)).length) {
                        ...
                        // APPLY_TO_DRAWONMAPS
                        $('#allmarks').append('<div id="circle_' + map_circles.indexOf(map_circle) + '_div"><input name="circle_title[]" type="text" id="circle_' + map_circles.indexOf(map_circle) + '" value="Circle #' + map_circles.indexOf(map_circle) + '"><input name="circle_coords[]" id="circle_coords_' + map_circles.indexOf(map_circle) + '" type="text" value="' + path_circle + '">&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-xs" id="circle_' + map_circles.indexOf(map_circle) + '_edit" >Edit</button>&nbsp;&nbsp;<button type="button" class="btn btn-danger btn-xs" id="circle_' + map_circles.indexOf(map_circle) + '_delete" >Remove</button></div>');
                    }
                    setCircleEditable(map_circles.indexOf(map_circle), false);
                    
                    // delete circle and its input boxes - APPLY_TO_DRAWONMAPS
                    $('#circle_' + map_circles.indexOf(map_circle) + '_delete').on("click", function () {
                        deleteCircle(map_circles.indexOf(map_circle));
                    });

                    // edit circle and its input boxes - APPLY_TO_DRAWONMAPS
                    $('#circle_' + map_circles.indexOf(map_circle) + '_edit').on("click", function () {
                        editCircle(map_circles.indexOf(map_circle));
                    });                     
                }
                initButtonsStatus();
                $('#basic_options :input').removeAttr('disabled');
        ...
        GMaps.on('marker_added', map, function (marker) {
            ...
            $('#marker_' + map.markers.indexOf(marker) + '_rmv').on("click", function () {
                deleteMarker(map.markers.indexOf(marker));
            });             
        });
    ...
    function loadPolyline(path, title) {
        ...
        // APPLY_TO_DRAWONMAPS
        $('#allmarks').append('<div id="line_' + map_polylines.indexOf(map_line) + '_div"><input name="line_title[]" type="text" id="line_' + map_polylines.indexOf(map_line) + '" value="' + title + '"><input name="line_coords[]" id="line_coords_' + map_polylines.indexOf(map_line) + '" type="text" value="' + path + '">&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-xs" id="line_' + map_polylines.indexOf(map_line) + '_edit" >Edit</button>&nbsp;&nbsp;<button type="button" class="btn btn-danger btn-xs" id="line_' + map_polylines.indexOf(map_line) + '_delete">Remove</button></div>');
    ...
    function loadPolygon(path, title) {
        ...
        // APPLY_TO_DRAWONMAPS
        $('#allmarks').append('<div id="poly_' + map_polygons.indexOf(map_polygon) + '_div"><input name="poly_title[]" type="text" id="poly_' + map_polygons.indexOf(map_polygon) + '" value="' + title + '"><input name="poly_coords[]" id="poly_coords_' + map_polygons.indexOf(map_polygon) + '" type="text" value="' + path + '">&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-xs" id="poly_' + map_polygons.indexOf(map_polygon) + '_edit" >Edit</button>&nbsp;&nbsp;<button type="button" class="btn btn-danger btn-xs" id="poly_' + map_polygons.indexOf(map_polygon) + '_delete" >Remove</button></div>');
    ...
    function loadRectangle(path, title) {
        ...
        // APPLY_TO_DRAWONMAPS
        $('#allmarks').append('<div id="rect_' + map_rectangles.indexOf(map_rectangle) + '_div"><input name="rect_title[]" type="text" id="rect_' + map_rectangles.indexOf(map_rectangle) + '" value="' + title + '"><input name="rect_coords[]" id="rect_coords_' + map_rectangles.indexOf(map_rectangle) + '" type="text" value="' + path + '">&nbsp;&nbsp;<button type="button" class="btn btn-primary btn-xs" id="rect_' + map_rectangles.indexOf(map_rectangle) + '_edit" >Edit</button>&nbsp;&nbsp;<button type="button" class="btn btn-danger btn-xs" id="rect_' + map_rectangles.indexOf(map_rectangle) + '_delete" >Remove</button></div>');
